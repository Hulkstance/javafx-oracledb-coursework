...
(customer_t(1, 'admin@test.com', '123456', name_t('Test', 'Admin'), address_t('Sofia', 'bul. Bulgaria 3', 'Sofia', '7000'), '0888123456'));

INSERT INTO "USER" VALUES
(customer_t(2, 'ivan@test.com', '123457', name_t('Ivan', 'Ivanov'), address_t('Ruse', 'bul. Bulgaria 4', 'Ruse', '7200'), '0888123457'));

INSERT INTO "USER" VALUES
(staff_t(3, 'maria@gmail.com', '222222', name_t('Maria', 'Petrova'), address_t('Ruse', 'unknown', 'Ruse', '7200'), '0884555666', 700, (SELECT REF(r) FROM "RANK" r WHERE rankno = 1)));

INSERT INTO "USER" VALUES
(staff_t(4, 'alex@gmail.com', '444444', name_t('Alex', 'Peneva'), address_t('Ruse', 'Rodina 3', 'Ruse', '7200'), '0884555677', 1200, (SELECT REF(r) FROM "RANK" r WHERE rankno = 3)));
